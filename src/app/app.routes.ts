...
import { IndayStoreBorrowersComponent } from './borrowers/inday-store-borrowers/inday-store-borrowers.component';
...
export const routes: Routes = [
    ...
    { path: 'borrowers', component: IndayStoreBorrowersComponent}
];
